 ...
 * @return {type}
 */
var GooglePlay = (function GooglePlay(username, password, androidId, useCache, debug, requestsDefautParams) {
  // default for args:
  ...
  if(requestsDefautParams) {
	request = Promise.promisifyAll(require('request').defaults( requestsDefautParams ) );
  }
