 ...
 * @return {type}
 */
var GooglePlay = (function GooglePlay(username, password, androidId, useCache, debug, requestsDefaults) {
  // default for args:
  ...
  // If defaults for 'requests' were passed, let's use them.
  if(requestsDefaults) {
	request = Promise.promisifyAll(require('request').defaults(requestsDefaults));
  }
